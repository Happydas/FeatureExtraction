package dbpedia.vec.it.paravector;
...
import dbpedia.vec.it.sequencevector.iterator.AbstractSequenceIterator;
...
import dbpedia.vec.format.docIterator.*;
import dbpedia.vec.format.docIterator.interoperability.DocumentIteratorConverter;
import dbpedia.vec.format.invertedindex.InvertedIndex;
