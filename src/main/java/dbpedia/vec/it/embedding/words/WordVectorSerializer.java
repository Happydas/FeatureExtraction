package dbpedia.vec.it.embedding.words;
        ...
        import dbpedia.vec.it.embedding.load.impl.BasicModelUtils;
        import dbpedia.vec.it.embedding.vectors.WordVectors;
        import dbpedia.vec.it.globe.Glove;
        import dbpedia.vec.it.paravector.ParagraphVectors;
        ...
        import dbpedia.vec.it.sequencevector.serialization.VocabWordFactory;
        import dbpedia.vec.it.word2vec.StaticWord2Vec;
        import dbpedia.vec.it.word2vec.VocabWord;
        import dbpedia.vec.it.word2vec.Word2Vec;
        import dbpedia.vec.it.word2vec.wordrepo.VocabCache;
        import dbpedia.vec.it.word2vec.wordrepo.VocabularyHolder;
        import dbpedia.vec.it.word2vec.wordrepo.VocabularyWord;
        import dbpedia.vec.it.word2vec.wordrepo.memory.AbstractCache;
        import dbpedia.vec.it.word2vec.wordrepo.memory.InMemoryLookupCache;
        import dbpedia.vec.format.docIterator.LabelsSource;
        ...
        import dbpedia.vec.it.embedding.vectors.WordVectorsImpl;
        import dbpedia.vec.util.OneTimeLogger;
