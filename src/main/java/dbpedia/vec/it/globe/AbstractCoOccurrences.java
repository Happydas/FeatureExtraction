...
import dbpedia.vec.it.globe.count.*;
import dbpedia.vec.it.sequencevector.intface.SequenceIterator;
import dbpedia.vec.it.sequencevector.iterator.FilteredSequenceIterator;
import dbpedia.vec.it.sequencevector.iterator.SynchronizedSequenceIterator;
...
import dbpedia.vec.format.senteneiterator.SynchronizedSentenceIterator;
