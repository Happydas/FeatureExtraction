package dbpedia.vec.it.sequencevector;
...
import dbpedia.vec.it.embedding.learning.alg.sequence.DBOW;
import dbpedia.vec.it.embedding.learning.alg.sequence.DM;
import dbpedia.vec.it.embedding.words.VectorsConfiguration;
import dbpedia.vec.it.embedding.words.WordVectorSerializer;
import dbpedia.vec.it.embedding.load.ModelUtils;
...
import dbpedia.vec.it.sequencevector.intface.VectorsListener;
...
import dbpedia.vec.it.word2vec.wordrepo.VocabConstructor;
